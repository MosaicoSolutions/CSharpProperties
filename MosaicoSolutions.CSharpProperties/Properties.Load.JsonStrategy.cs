...
@"{
    ...
    'items': {
        ...
        public static IProperties LoadFromJsonString(string json)
        {
        ...
        public static Task<IProperties> LoadFromJsonStringAsync(string json)
        {
            ...
            {
                using (stream)
                    return await LoadFromJsonAsync(stream);
            });
        }
